                ...
                flexibleSpace: LayoutBuilder(builder:
                  ...
                  return Container(
                    ...
                    child: FlexibleSpaceBar(
                        ...
                        children: [
                          AnimatedOpacity(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  child: Image.network(RiderAppCubit.get(context)
                                      .profileImage ??
                                ...
                                Text(
                                  // 'top.toString()',
                                  RiderAppCubit.get(context).name == null
                                      ?  cubit.getTexts('user1')
                                    : RiderAppCubit.get(context).name,
                      ...
                      background: Image.network(RiderAppCubit.get(context)
                          .profileImage ??
                          'https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png',
                        fit: BoxFit.fill,
                        errorBuilder:(context,child,progress){
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${RiderAppCubit.get(context).email}',
                                      style: Theme.of(context)
                                          .textTheme
                                          .caption
                                          .copyWith(fontSize: 10.sp),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${RiderAppCubit.get(context).phone}',
                                      style: Theme.of(context)
                                          .textTheme
                                          .caption
                                          .copyWith(fontSize: 10.sp),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${RiderAppCubit.get(context).address}',
                                      style: Theme.of(context)
                                          .textTheme
                                          .caption
                                          .copyWith(fontSize: 10.sp),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${RiderAppCubit.get(context).joinedAt}',
                                      style: Theme.of(context)
                                          .textTheme
                                          .caption
                                          .copyWith(fontSize: 10.sp),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FlutterSwitch(
                            ...
                            height: 4.h,
                            toggleSize: 16.0.sp,
                            value: RiderAppCubit.get(context).isDark ? true : false,
                            borderRadius: 30.0,
                            padding: 0.0,
                            ...
                            onToggle: (value) {
                              RiderAppCubit.get(context).changeThemeMode();
                            },
                          ),
                        ],
                      ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FlutterSwitch(
                            ...
                            height: 4.h,
                            toggleSize: 16.0.sp,
                            value: RiderAppCubit.get(context).isEn ? true : false,
                            borderRadius: 30.0,
                            padding: 0.0,
                            activeToggleColor: Colors.white,
                            inactiveToggleColor: Colors.white,
                            ...
                            inactiveColor: Colors.grey,
                            onToggle: (value) {
                              RiderAppCubit.get(context).changeLanguage();
                              RiderAppCubit.get(context).getLan();
                      ...
                      child: InkWell(
                        onTap: () {
                          showDialoggLogout(context, cubit.getTexts('user15'),
                            ...
                            RiderAppCubit.get(context).signOut(context);
                          });
                        },
                        splashColor: Theme.of(context).splashColor,
                        child: Padding(
